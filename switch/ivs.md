...
| |Required|ether|vlan|mpls|pbb|
|-----------|----|----|----|----|----|
|[IP_DSCP (IPv4)](https://github.com/osrg/ryu/tree/master/ryu/tests/switch/of13/match/08_IP_DSCP_IPv4.json)|- | [OK](#0445f4506456f0406f5f718b15173da7) / [OK](#0445f4506456f0406f5f718b15173da7) / [OK](#0445f4506456f0406f5f718b15173da7) | [OK](#0445f4506456f0406f5f718b15173da7) / [OK](#0445f4506456f0406f5f718b15173da7) / [OK](#0445f4506456f0406f5f718b15173da7) | [ERROR](#0445f4506456f0406f5f718b15173da7) / [ERROR](#0445f4506456f0406f5f718b15173da7) / [ERROR](#0445f4506456f0406f5f718b15173da7) |
...
<pre>
    ...
    ethernet/mpls/ipv4(tos=65)/tcp-->'actions=pop_mpls:0x0800,goto_table:1','table_id:1,ip_dscp=8,actions=output:2' ERROR
        Failed to add flows: OFPErrorMsg[type=0x05, code=0x00]
bash: line 1:  2413 Killed                  ryu-manager ryu/tests/switch/tester.py
+ /bin/true
+ TITLE=ivs
+ DIR=ivs
++ source /home/jenkins/get_log
++++ echo ivs
+++ CMD_GET_LOG='cd /home/ruikubo/jenkins/ivs; git log -n 1 --oneline;'
+++ ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/var/lib/jenkins/.ssh/known_host -i /home/jenkins/id_dsa 10.24.150.20 -l ruikubo 'cd /home/ruikubo/jenkins/ivs; git log -n 1 --oneline;'
+ LOG='4881841 Merge into master from pull request #129: OVSDriver: wrap large constant in UINT64_C (https://github.com/floodlight/ivs/pull/129)'
+ source /home/jenkins/push_result
++ URL=git@github.com:osrg/ryu-certification.git
++ DIR=ryu-certification
++ SSHCMD_MIYAGUNI='ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/var/lib/jenkins/.ssh/known_host -i /home/jenkins/id_dsa 10.24.100.30 -l ruikubo'
++ ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/var/lib/jenkins/.ssh/known_host -i /home/jenkins/id_dsa 10.24.100.30 -l ruikubo 'set -x; cd /home/ruikubo/jenkins; rm -rf ryu-certification; git clone git@github.com:osrg/ryu-certification.git;'
+ cd /home/ruikubo/jenkins
+ rm -rf ryu-certification
...
++ '[' ivs = ofsoftswitch13 ']'
++ '[' ivs = ivs ']'
++ ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/var/lib/jenkins/.ssh/known_host -i /home/jenkins/id_dsa 10.24.100.30 -l ruikubo 'set -x; cd /home/ruikubo/jenkins; source /home/jenkins/push_config_ivs; cp -p ivs.md ryu-certification/switch/config;'
+ cd /home/ruikubo/jenkins
+ source /home/jenkins/push_config_ivs
++ DIR=ryu-certification
++ FILE_VSCTL=/home/ruikubo/jenkins/vsctl.txt
++ FILE_GITLOG=/home/ruikubo/jenkins/gitlog.txt
++ FILE_OUTPUT=/home/ruikubo/jenkins/ivs.md
++ TARGET_ADDRESS=10.24.150.20
++ SSHCMD_TARGET='ssh 10.24.150.20 '
++ SSHCMD_MIYAGUNI='ssh 10.24.100.30 '
++ CMD_OVS_VER='modinfo openvswitch'
++ CMD_GITLOG1='git log -1 --pretty=fuller'
++ ssh 10.24.150.20 'set -x; cd /home/ruikubo/download/ivs; echo       '\''$ '\''git log -1 --pretty=fuller  > /home/ruikubo/jenkins/gitlog.txt; git log -1 --pretty=fuller &>> /home/ruikubo/jenkins/gitlog.txt;'
+ cd /home/ruikubo/download/ivs
+ echo '$ git' log -1 --pretty=fuller
+ git log -1 --pretty=fuller
++ ssh 10.24.150.20 'set -x; cd /home/ruikubo/download/ivs; echo -e '\''\n$ '\''modinfo openvswitch >> /home/ruikubo/jenkins/gitlog.txt; modinfo openvswitch >> /home/ruikubo/jenkins/gitlog.txt;'
+ cd /home/ruikubo/download/ivs
+ echo -e '\n$ modinfo' openvswitch
+ modinfo openvswitch
++ ssh 10.24.150.20 'sed -i '\''s/&/\&amp;/g'\'' /home/ruikubo/jenkins/gitlog.txt; sed -i '\''s/</\&lt;/g'\'' /home/ruikubo/jenkins/gitlog.txt; sed -i '\''s/>/\&gt;/g'\'' /home/ruikubo/jenkins/gitlog.txt;'
++ ssh 10.24.100.30 'set -x; scp -p 10.24.150.20:/home/ruikubo/jenkins/gitlog.txt /home/ruikubo/jenkins'
+ scp -p 10.24.150.20:/home/ruikubo/jenkins/gitlog.txt /home/ruikubo/jenkins
+++ cat /home/ruikubo/jenkins/gitlog.txt
++ TXT_GITLOG='$ git log -1 --pretty=fuller
...
srcversion:     A178E5D4A2F5B4CC615D9EB
...
depends:        libcrc32c,gre
vermagic:       3.2.0-29-generic SMP mod_unload modversions
</pre>" > /home/ruikubo/jenkins/ivs.md'
+ echo '---
layout: default
title: Ryu Certification - ivs - config
---
...
+ cp -p ivs.md ryu-certification/switch/config
+++ grep -n 'action: 00_OUTPUT' /var/lib/jenkins/jobs/tester_ivs/workspace/../builds/48/log
+++ head -n1
+++ cut -f1 -d:
+++ echo /var/lib/jenkins/jobs/tester_ivs/workspace
++ CMD_PUSH_RESULT='set -x; cd /home/ruikubo/jenkins/ryu-certification; tail -n +4577 /var/lib/jenkins/jobs/tester_ivs/workspace/../builds/48/log | python /home/jenkins/raw2markdown.py.20131212 ivs > switch/ivs.md; git add .; git commit -m '\''ivs: 4881841 Merge into master from pull request #129: OVSDriver: wrap large constant in UINT64_C (https://github.com/floodlight/ivs/pull/129)'\''; git push;'
++ ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/var/lib/jenkins/.ssh/known_host -i /home/jenkins/id_dsa 10.24.100.30 -l ruikubo 'set -x; cd /home/ruikubo/jenkins/ryu-certification; tail -n +4577 /var/lib/jenkins/jobs/tester_ivs/workspace/../builds/48/log | python /home/jenkins/raw2markdown.py.20131212 ivs > switch/ivs.md; git add .; git commit -m '\''ivs: 4881841 Merge into master from pull request #129: OVSDriver: wrap large constant in UINT64_C (https://github.com/floodlight/ivs/pull/129)'\''; git push;'
+ cd /home/ruikubo/jenkins/ryu-certification
+ tail -n +4577 /var/lib/jenkins/jobs/tester_ivs/workspace/../builds/48/log
+ python /home/jenkins/raw2markdown.py.20131212 ivs
</pre>
