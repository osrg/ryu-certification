...
|[POP_MPLS](https://github.com/osrg/ryu/tree/master/ryu/tests/switch/of13/action/20_POP_MPLS.json)|- | [OK](#9df48d86c13b11c4f384f69242ec75bb) | [ERROR](#9df48d86c13b11c4f384f69242ec75bb) | [ERROR](#9df48d86c13b11c4f384f69242ec75bb) |
...
<pre>
    ethernet/ipv4/tcp-->'eth_type=0x0800,actions=push_mpls:0x8847,output:2'                              ERROR
        Received incorrect packet: mpls(ttl=63)
    ethernet/ipv6/tcp-->'eth_type=0x86dd,actions=push_mpls:0x8847,output:2'                              ERROR
        Received incorrect packet: mpls(ttl=63,label=2)
...
<pre>
    ...
    ethernet/mpls/ipv6/tcp-->'eth_type=0x8847,actions=pop_mpls:0x86dd,output:2'                          ERROR
        Received incorrect packet: ethernet(ethertype=2048)/ipv4(csum=0,dst='0.0.0.0',flags=0,header_length=2,identification=55,offset=1600,option=None,proto=16,src='0.0.0.0',tos=0,total_length=100,ttl=0,version=6)/str('\x00\x10\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x10\x00 \x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00 +g\x08\xae\x00\x00\x00\x00\x00\x00\x00\x00`\x00\x00\x00j\\\x00\x00\x00\x00\x00\x00\x01\x02\x03\x04\x05\x06\x07\x08\t\n\x0b\x0c\r\x0e\x0f\x10\x11\x12\x13\x14\x15\x16\x17\x18\x19\x1a\x1b\x1c\x1d\x1e\x1f')
    ethernet/mpls/arp-->'eth_type=0x8847,actions=pop_mpls:0x0806,output:2'                               ERROR
        Received incorrect packet: ethernet(ethertype=2048)/udp(csum=1,dst_port=2048,src_port=1,total_length=1540)/str('\x12\x11\x11\x11\x11\x11\xc0\xa8\n\n""""""\xc0\xa8\x14\x14\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00')
</pre>
...
<pre>
    ethernet/ipv4(tos=32)/tcp-->'ip_ecn=0,actions=set_field:1->ip_ecn,output:2'                          ERROR
        Received incorrect packet: ipv4(tos=1,csum=56125)
...
<pre>
    ethernet/ipv4/sctp(src_port=11111)-->'sctp_src=11111,actions=set_field:12345->sctp_src,output:2'     ERROR
        Received incorrect packet: sctp(csum=1142762084,dst_port=0)
...
<pre>
    ethernet/ipv4/sctp(dst_port=2222)-->'sctp_dst=2222,actions=set_field:6789->sctp_dst,output:2'        ERROR
        Received incorrect packet: sctp(csum=3128045428,src_port=0)
...
<pre>
    ethernet/ipv6(traffic_class=32)/tcp-->'ip_ecn=0,actions=set_field:1->ip_ecn,output:2'                ERROR
        Received incorrect packet: ipv6(traffic_class=1)
...
<pre>
    ethernet/ipv6(src='10::10')/tcp-->'ipv6_src=10::10,actions=set_field:a0::a0->ipv6_src,output:2'      ERROR
        Received incorrect packet: ipv6(src='a0::10')/tcp(csum=27228)
...
<pre>
    ethernet/ipv6(dst='20::20')/tcp-->'ipv6_dst=20::20,actions=set_field:b0::b0->ipv6_dst,output:2'      ERROR
        Received incorrect packet: ipv6(dst='b0::20')/tcp(csum=27228)
...
..........
    2Mbps(ethernet/ipv4/tcp)-->'in_port=1,actions=group:all(actions=output:2/actions=output:3)'          ERROR
        Received unexpected throughput: {'in_port': 2} 1658.68kbps, {'in_port': 3} 1658.68kbps
..........
    2Mbps(ethernet/ipv6/tcp)-->'in_port=1,actions=group:all(actions=output:2/actions=output:3)'          ERROR
        Received unexpected throughput: {'in_port': 2} 1657.34kbps, {'in_port': 3} 1657.34kbps
..........
    2Mbps(ethernet/arp)-->'in_port=1,actions=group:all(actions=output:2/actions=output:3)'               ERROR
        Received unexpected throughput: {'in_port': 2} 1658.90kbps, {'in_port': 3} 1658.90kbps
</pre>
...
..........
    2Mbps(ethernet/ipv4(src=random,dst=random)/tcp(src_port=random,dst_port=random))-->'in_port=1,actions=group:select(actions=output:2/actions=output:3)' ERROR
        Received unexpected throughput: {'in_port': 2} 487.48kbps, {'in_port': 3} 485.13kbps
..........
    2Mbps(ethernet/ipv6(src=random,dst=random)/tcp(src_port=random,dst_port=random))-->'in_port=1,actions=group:select(actions=output:2/actions=output:3)' ERROR
        Received unexpected throughput: {'in_port': 2} 1658.12kbps, {'in_port': 3} 0.00kbps
..........
    2Mbps(ethernet/arp(src_ip=random,dst_ip=random)-->'in_port=1,actions=group:select(actions=output:2/actions=output:3)' ERROR
        Received unexpected throughput: {'in_port': 2} 1690.10kbps, {'in_port': 3} 0.00kbps
</pre>
...
<pre>
    2Mbps(ethernet/ipv4/tcp)-->'in_port=1,actions=meter:1Mbps(drop),output:2'                            ERROR
        Added incorrect meters: meter_stats(flags=1,meter_id=1,bands=[OFPMeterBandDrop(burst_size=13,len=16,rate=1000,type=1)])
...
<pre>
    20Mbps(ethernet/ipv4/tcp)-->'in_port=1,actions=meter:10Mbps(drop),output:2'                          ERROR
        Added incorrect meters: meter_stats(flags=1,meter_id=1,bands=[OFPMeterBandDrop(burst_size=13,len=16,rate=10000,type=1)])
...
<pre>
    200Mbps(ethernet/ipv4/tcp)-->'in_port=1,actions=meter:100Mbps(drop),output:2'                        ERROR
        Added incorrect meters: meter_stats(flags=1,meter_id=1,bands=[OFPMeterBandDrop(burst_size=13,len=16,rate=100000,type=1)])
...
<pre>
    2Mbps(ethernet/ipv4(dscp=24)/tcp)-->'in_port=1,actions=meter:1Mbps(dscp_remark:ip_dscp=16),output:2' ERROR
        Added incorrect meters: meter_stats(flags=1,meter_id=1,bands=[OFPMeterBandDscpRemark(burst_size=13,len=16,prec_level=1,rate=1000,type=2)])
...
<pre>
    20Mbps(ethernet/ipv4(dscp=24)/tcp)-->'in_port=1,actions=meter:10Mbps(dscp_remark:ip_dscp=16),output:2' ERROR
        Added incorrect meters: meter_stats(flags=1,meter_id=1,bands=[OFPMeterBandDscpRemark(burst_size=13,len=16,prec_level=1,rate=10000,type=2)])
...
<pre>
    200Mbps(ethernet/ipv4(dscp=24)/tcp)-->'in_port=1,actions=meter:100Mbps(dscp_remark:ip_dscp=16),output:2' ERROR
        Added incorrect meters: meter_stats(flags=1,meter_id=1,bands=[OFPMeterBandDscpRemark(burst_size=13,len=16,prec_level=1,rate=100000,type=2)])
